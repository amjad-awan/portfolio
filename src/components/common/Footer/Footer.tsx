...
const Footer = () => {
  return (
    <>
      <div className="max-w-[1200px] px-[20px] md:px-[0px] gap-[30px] mx-auto mt-[120px] grid grid-cols-1  lg:grid-cols-3">
        <div>
          ...
          <h3 className="text-[#fff] text-[20px] mb-[5px] lg:mb-[10px] font-[500] font-primary">
            address
          </h3>
          <p className="text-[var(--body-color)] text-[16px] font-[400] font-primary  leading-[30px] block ">
        ...
        <div>
          ...
          <a
            href="Tel:03027543636"
            className="text-[var(--body-color)] transition-all duration-500 hover:text-[var(--color-primary)] font-primary  text-[16px] font-[400] leading-[30px] block "
          >
            03027543636{" "}
          </a>
        ...
        <div>
          ...
          <a
            ...
            className="text-[var(--body-color)] transition-all duration-500 hover:text-[var(--color-primary)] text-[16px] font-[400] font-primary leading-[30px] block "
          >
