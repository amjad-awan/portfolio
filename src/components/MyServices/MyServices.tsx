...
const cards = [
  {
    title: "Responsive & Modern Web Design",
    svg: (
      <svg
        width="99"
        height="101"
    ...
    description:
      "Craft visually appealing, user-friendly websites that deliver optimal performance on all devices.",
  },
  {
    ...
    description:
      "Integrate APIs effortlessly to enhance functionality and ensure smooth data flows within applications.",
  },
  {
    ...
    description:
      "Deliver robust, scalable applications with expertise in both front-end and back-end development.",
  },
  {
    ...
    <div className="py-[130px]" id="services" >
      <div className="max-w-[700px] mx-auto">
        <SectionsHead
          ...
          lableText="MY SERIVCE"
          hPosition="center"
          h="Crafting stories through
design and innovation"
        />
      </div>
      <div className="max-w-[1200px] px-[20px] lg:px-[0px]   mx-auto  gap-x-[20px]  grid gap-y-[50px] mt-[100px] sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {cards.map((services, index) => {
          return <ServiceCard key={index} index={index} {...services} />;
        })}
      </div>
    </div>
  );
